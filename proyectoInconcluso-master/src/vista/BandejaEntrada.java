...
public class BandejaEntrada extends javax.swing.JFrame {
    ...
    public BandejaEntrada(int idUsuarioLogueado) {
        ...
        jButton1.addActionListener(new BandejaController(this));
        rellenarTabla();
    ...
    private void rellenarTabla() {
        ...
        ArrayList<Mensaje> mensajes=md.getMensajes(idUsuarioLogueado);
        
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();

        for (int i = 0; i <mensajes.size(); i++) {
            Object[] fila = {mensajes.get(i).getEmisor(),mensajes.get(i).getContenido()};
            dtm.addRow(fila);
        }
    }
